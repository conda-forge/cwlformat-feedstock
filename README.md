About cwlformat-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cwlformat-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9981&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cwlformat-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cwlformat` can be installed with `conda`:
...
```
mamba install cwlformat
```

It is possible to list all of the versions of `cwlformat` available on your platform with `conda`:
...
```
mamba search cwlformat --channel conda-forge
```
...
mamba repoquery search cwlformat --channel conda-forge

# List packages depending on `cwlformat`:
mamba repoquery whoneeds cwlformat --channel conda-forge

# List dependencies of `cwlformat`:
mamba repoquery depends cwlformat --channel conda-forge
```
